...
similar to the format() method, but instead of positional or keyword arguments, it takes a
mapping object as its argument.
9) index() - Searches the string for a specified value and returns the position of where it was
found.
...
22) rfind()- Searches the string for a specified value and returns the last position of where it
was found.
